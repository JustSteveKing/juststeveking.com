...
devTo: 'https://dev.to/juststevemcd/from-diagram-to-implementation-plan-5coi'
order: 9
---
...
_In the final article, we are going to step back from Clarity and talk about what this entire process represents: the shift in thinking that defines a mid-level developer, and where to take these skills from here._
