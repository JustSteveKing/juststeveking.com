...
_Next in the series: Running a Betting Table - the operational mechanics of Shape Up planning, how to run the cycle, protect the cooldown, and push back on the urgency that is almost never as urgent as it appears._
