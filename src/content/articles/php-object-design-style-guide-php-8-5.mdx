...
Matthias Noback's _Object Design Style Guide_ arrived in 2019 as something different. It wasn't another framework tutorial or architectural pattern cookbook. It was a book about how to think about objects themselves. Their responsibilities, boundaries, and contracts.
...
The _Object Design Style Guide_ taught a generation of PHP developers how to think about objects. The principles were always sound. What's changed is the cost of implementing them.
