...
devTo: 'https://dev.to/juststevemcd/shaping-before-you-build-5c5l'
order: 4
---
...
_In the next article, we are going to move from features into data, and look at how to draw your first Entity Relationship Diagram before you write a single migration._
