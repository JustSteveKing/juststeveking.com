...
description: Build a live blog with Statamic in Laravel and deploy to Digital Ocean from your IDE.
category: Laravel
pubDate: 2022-09-02
image: '/images/social/articles/from-idea-to-blog-to-live.png'
minRead: 7
author:
...
const statamic = new digitalocean.App('statamic-website', {
	spec: {
		...
		staticSites: [
			{
				buildCommand:
					'composer install --prefer-dist --optimize-autoloader && php please cach:clear && npm ci && npm run production && php please ssg:generate',
				git: {
					branch: 'main',
