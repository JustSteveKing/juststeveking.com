...
pubDate: 2025-10-08
tags:
  ['PHP', 'Static Sites', 'Tempest', 'SSG', 'Performance', 'Web Development', 'Sevalla', 'JAMstack']
draft: false
sponsor:
  name: Sevalla
...
_This article was originally published on [Sevalla Blog](https://sevalla.com/blog/static-site-generation-php/). Follow me on [Twitter](https://twitter.com/juststeveking) for more PHP and web development insights._
