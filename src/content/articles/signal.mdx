			...
			"methods": [
				{
					...
					"emits": [
						{
							"event": "OrderPlaced",
							"description": "Dispatched after the order is persisted",
							"tags": []
						}
					],
					"side_effects": [
...
_If you build something interesting with the JSON output, whether that is a custom portal, a CI gate, or something I haven't thought of, I would genuinely like to hear about it._
