...
export const home: Metadata = {
	title: 'I help SaaS teams fix slow, unreliable APIs',
	description:
...
export const articles: Metadata = {
	title: 'Articles',
	description:
		'Writing on PHP, Laravel, API design, and engineering leadership by Steve McDougall.',
};

export const projects: Metadata = {
	title: 'Packages',
	description: 'Open source PHP packages by Steve McDougall, available on Packagist.',
};

export const about: Metadata = {
	title: 'About',
	description:
		'Steve McDougall — Technical Director, API consultant, and educator based in Wales, UK. 15+ years building, leading, and improving software teams.',
};

export const uses: Metadata = {
	title: 'Uses',
	description: 'Hardware, software, and services Steve McDougall uses daily for PHP development.',
};

export const work: Metadata = {
	title: 'Work',
	description:
		'Steve McDougall career history — Technical Director, API consultant, developer educator, and PHP-FIG Core Committee member.',
};
