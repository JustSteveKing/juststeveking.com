...
<style>
  ...
  .scores-label.visible { opacity: 1; }
  ...
  .score-wrap.visible { opacity: 1; transform: translateY(0); }

  @media (max-width: 900px) {
    .scores-row { grid-template-columns: repeat(2, minmax(0, 1fr)); }
  }

  @media (max-width: 720px) {
    .scores-section { padding: 36px 20px 28px; }
  }
